...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen bg-gradient-hero flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute bottom-32 left-16 w-6 h-6 bg-primary-glow/30 rounded-full animate-float" style={{animationDelay: '1s'}}></div>
      <div className="absolute top-1/2 right-32 w-3 h-3 bg-white/30 rounded-full animate-float" style={{animationDelay: '2s'}}></div>
    </section>
  );
};
